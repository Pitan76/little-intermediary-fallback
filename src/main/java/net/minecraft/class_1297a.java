...
// Entity
public abstract class class_1297a extends Entity implements class_1297 {
    public class_1297a(EntityType<?> type, Level level) {
        super(type, level);
    }
    ...
    public void method_51502(Level world) {
