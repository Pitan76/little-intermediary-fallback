...
public class class_5250a extends MutableComponent implements class_5250 {

    public class_5250a(ComponentContents contents, List<Component> siblings, Style style) {
