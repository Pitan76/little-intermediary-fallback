...
// BlockPos
public class class_2338a extends BlockPos implements class_2338 {

    public class_2338a(int x, int y, int z) {
        super(x, y, z);
    }

    public class_2338a(Vec3i vec3i) {
        super(vec3i);
    }

    public class_2338a(class_2382 vec3i) {
        super((Vec3i) vec3i);
    }
